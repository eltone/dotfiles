...
you should place your code here."
  ...
  (spacemacs/set-leader-keys-for-major-mode 'elixir-mode
    "ma" 'alchemist-run-credo-on-project)
  ...
  (spacemacs/set-leader-keys (kbd "*") 'counsel-search-rg)
)
